...
================================================
This script merge three different JSON files:
...
def find_location_match(temple_name, city, location_temples):

    best = None
    best_score = 0

    for loc in location_temples:

        # City must match first
        if city.lower() != loc.get("search_city","").lower():
            continue
